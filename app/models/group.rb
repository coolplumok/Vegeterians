...
class Group < ApplicationRecord
  ...
  has_many :pending_applications, class_name: "GroupJoinPrivate", foreign_key: "group_id", dependent: :destroy
  has_many :approve_join_privates, class_name: "GroupApproveJoinPrivate", foreign_key: "group_id", dependent: :destroy
  ...
  def make_featured
    self.update(is_featured: true) if self.account.is_proplus?
  end
