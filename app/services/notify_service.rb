...
class NotifyService < BaseService
  ...
  def blocked_group_invite?
    false
  end

  def blocked_group_invite_request?
    false
  end

  def blocked_group_join_private?
    false
  end

  def blocked_group_join_private_request?
    false
  end

  def blocked_group_approve_join_private?
    false
  end

  def blocked_group_approve_join_private_request?
    false
  end

  def blocked_health_expert_application?
    false
  end

  def blocked_health_expert_application_request?
    false
  end

  def blocked_health_expert_approve?
    false
  end

  def blocked_health_expert_approve_request?
    false
  end
