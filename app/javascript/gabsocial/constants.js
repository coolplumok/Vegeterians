...
export const APP_NAME = 'Vegeterians.live'
...
export const URL_GAB_PRO = 'https://Vegeterians.network'
export const URL_GAB_PRO_LEARN_MORE = 'https://Vegeterians.network'
export const URL_GAB_PRO_UPGRADE = 'https://Vegeterians.network/Vegeterians-health-network-pricing/'
...
export const MODAL_UPGRADE_FLASH_MESSAGE = 'UPGRADE_FLASH_MESSAGE'
...
export const MODAL_SUBSCRIPTION = 'SUBSCRIPTION'
export const MODAL_EDIT_BIO = 'EDIT_BIO'
export const MODAL_NOTIFY_EDIT_PROFILE = 'NOTIFY_EDIT_PROFILE'
export const MODAL_GROUP_INVITE_FOLLOWERS = 'GROUP_INVITE_FOLLOWERS'
export const MODAL_GROUP_JOIN_PRIVATE = 'GROUP_JOIN_PRIVATE'
export const MODAL_GROUP_PENDING_APPLICATIONS = 'GROUP_PENDING_APPLICATIONS'
export const MODAL_EDIT_MEDIA = 'EDIT_MEDIA'
export const MODAL_HEALTH_EXPRTS = 'HEALTH_EXPRTS'
