      ...
      <div className={[_s.default].join(' ')}>
        <Block>
          <div className={[_s.default, _s.px15, _s.py15].join(' ')}>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>Vegeterians NETWORK INC (”Company” or “We”) respect your privacy and are committed to protecting it through our compliance with this policy.</Text>

            <Text tagName='p' className={_s.mt15} size='medium'>
              This policy describes the types of information we may collect from you or that you may provide when you visit the websites Vegeterians.live, and Vegeterians.news, and any other online properties of Vegeterians Network Inc (each a “Website”) and our practices for collecting, using, maintaining, protecting, and disclosing that information.
            </Text>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>Our Website is not intended for children under 13 years of age. No one under age 18 may provide any information to or on the Website. We do not knowingly collect personal information from children under 13. If you are under 13, do not use or provide any information on this Website, register on the Website, make any purchases through the Website, use any of the interactive or public comment features of this Website, or provide any information about yourself to us, including your name, address, telephone number, email address, or any screen name or user name you may use. If we learn we have collected or received personal information from a child under 18 without verification of parental consent, we will delete that information and any associated accounts. If you believe we might have any information from or about a child under 13, please contact us at support [at] Vegeterians [dot] live.</Text>
            ...
            <ul className={[_s.default, _s.px15, _s.mt15, _s.ml15].join(' ')}>
              ...
              <li className={_s.mt10}>
                <Text tagName='p' size='medium'>If we believe disclosure is necessary or appropriate to protect the rights, property, or safety of Vegeterians Network Inc, our employees, our customers, or any other person.</Text>
              </li>
            </ul>
            ...
            <Text tagName='p' className={_s.mt15} size='medium'>You may also send us an email at support [at] Vegeterians [dot] live to request access to, correct or delete any personal information that you have provided to us. We cannot delete your personal information except by also deleting your user account. We may not accommodate a request to change information if we believe the change would violate any law or legal requirement or cause the information to be incorrect.</Text>
            <Text tagName='p' className={_s.mt15} size='medium'>
            ...
            <Text tagName='p' className={[_s.mt15, _s.mb15].join(' ')} size='medium'>
              <Button
                ...
                backgroundColor='none'
                className={_s.displayInline}
                href='mailto:support@Vegeterians.live'
              >
                support@Vegeterians.live
              </Button>
            </Text>
