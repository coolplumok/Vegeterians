...
class ActivityPub::Adapter < ActiveModelSerializers::Adapter::Base
  ...
  CONTEXT_EXTENSION_MAP = {
    ...
    emoji: { 'post' => 'http://joinmastodon.org/ns#', 'Emoji' => 'post:Emoji' },
    featured: { 'post' => 'http://joinmastodon.org/ns#', 'featured' => { '@id' => 'post:featured', '@type' => '@id' } },
    property_value: { 'schema' => 'http://schema.org#', 'PropertyValue' => 'schema:PropertyValue', 'value' => 'schema:value' },
    atom_uri: { 'ostatus' => 'http://ostatus.org#', 'atomUri' => 'ostatus:atomUri' },
    conversation: { 'ostatus' => 'http://ostatus.org#', 'inReplyToAtomUri' => 'ostatus:inReplyToAtomUri', 'conversation' => 'ostatus:conversation' },
    focal_point: { 'post' => 'http://joinmastodon.org/ns#', 'focalPoint' => { '@container' => '@list', '@id' => 'post:focalPoint' } },
    identity_proof: { 'post' => 'http://joinmastodon.org/ns#', 'IdentityProof' => 'post:IdentityProof' },
    blurhash: { 'post' => 'http://joinmastodon.org/ns#', 'blurhash' => 'post:blurhash' },
  }.freeze
