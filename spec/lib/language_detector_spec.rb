...
describe LanguageDetector do
  ...
  describe 'detect' do
    ...
    let(:account_remote) { Fabricate(:account, domain: 'Vegeterians.live') }

    it 'detects english language for basic strings' do
      strings = [
        "Hello and welcome to Vegeterians.live how are you today?",
        "I'd rather not!",
    ...
    it 'detects spanish language' do
      string = 'Obtener un Hola y bienvenidos a Vegeterians.live. Obtener un Hola y bienvenidos a Vegeterians.live. Obtener un Hola y bienvenidos a Vegeterians.live. Obtener un Hola y bienvenidos a Vegeterians.live'
      result = described_class.instance.detect(string, account_without_user_locale)
