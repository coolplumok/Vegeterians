...
describe InstancePresenter do
  ...
  describe '#source_url' do
    it 'returns "https://gitlab.com/Vegeterians-live/Vegeterians-social"' do
      expect(instance_presenter.source_url).to eq('https://gitlab.com/Vegeterians-live/Vegeterians-social')
    end
  end
