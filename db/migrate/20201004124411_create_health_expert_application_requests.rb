class CreateHealthExpertApplicationRequests < ActiveRecord::Migration[5.2]
  def change
    drop_table :health_expert_application_requests if ActiveRecord::Base.connection.tables.include?('health_expert_application_requests')

    create_table :health_expert_application_requests do |t|
