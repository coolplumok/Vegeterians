...
ActiveRecord::Schema.define(version: 2020_10_08_192810) do
  ...
  create_table "group_approve_join_private_requests", force: :cascade do |t|
    t.integer "account_id", null: false
  ...
  create_table "group_approve_join_privates", force: :cascade do |t|
    t.integer "account_id", null: false
    t.integer "group_id", null: false
    t.integer "target_account_id", null: false
    t.boolean "show_reblogs", default: true, null: false
  ...
  create_table "group_invite_requests", force: :cascade do |t|
    t.integer "account_id", null: false
    t.integer "group_id", null: false
    t.integer "target_account_id", null: false
    t.boolean "show_reblogs", default: true, null: false
  ...
  create_table "group_join_private_requests", force: :cascade do |t|
    t.integer "account_id", null: false
    t.integer "group_id", null: false
    t.integer "target_account_id", null: false
  ...
  create_table "group_join_privates", force: :cascade do |t|
    t.integer "account_id", null: false
    t.integer "group_id", null: false
    t.integer "target_account_id", null: false
    t.string "description"
  ...
  create_table "groups", force: :cascade do |t|
    ...
    t.boolean "is_privated", default: false
  ...
  create_table "health_expert_approve_requests", force: :cascade do |t|
    t.integer "account_id", null: false
    t.integer "target_account_id", null: false
    t.boolean "show_reblogs", default: true, null: false
    t.string "uri"
  ...
  create_table "health_expert_approves", force: :cascade do |t|
    t.integer "account_id", null: false
    t.integer "target_account_id", null: false
    t.boolean "show_reblogs", default: true, null: false
    t.string "uri"
