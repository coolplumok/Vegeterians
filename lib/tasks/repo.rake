...
namespace :repo do
  ...
  #   # contact us directly at legal@Vegeterians.live with any questions about the
  #   # contributors to Vegeterians.live.
  # end
  ...
  #               response = HTTP.headers('Authorization' => "token #{ENV['GITLAB_API_TOKEN']}").get("https://api.gitlab.com/repos/Vegeterians-live/Vegeterians-social/pulls/#{pull_request_number}")
